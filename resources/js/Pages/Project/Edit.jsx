...
import TetxAreaInput from '@/Components/TetxAreaInput'
            ...
            <form onSubmit={onSubmit} className='p-4 sm-p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg'>
              ...
              <div className='mb-5'>
                {project.data.image_path && <div>
                  <img src={project.data.image_path} className='w-40 h-40' />
                </div>}
              </div>
              ...
              <div className='mt-4'>
                ...
                <TetxAreaInput
                  ...
                  value={data.description} className='mt-1 block w-full'
              ...
              <div className='mt-4'>
                ...
                <SelectInput
                  id='project_status'
                  name='status'
                  value={data.status} className='mt-1 block w-full'
